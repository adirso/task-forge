...
test("projects configure available statuses and the default API status", async () => {
  ...
  assert.deepEqual(statusProject.availableStatuses, ["BACKLOG", "REFINING", "TODO", "IN_PROGRESS", "READY_FOR_REVIEW", "IN_REVIEW", "APPROVED", "FIX_NEEDED", "FIX_IN_PROGRESS", "RE_REVIEW", "PENDING_DECISION", "DONE", "CANCELLED", "FAILED"]);
