...
test("application layer owns the migrated route use cases", () => {
  ...
  for (const service of ["TaskApplicationService", "ProjectApplicationService", "PhaseApplicationService", "UserApplicationService", "NotificationApplicationService", "SearchApplicationService", "ContextApplicationService"]) {
