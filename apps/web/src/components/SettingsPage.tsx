    ...
    <div className="settings-page">
      ...
      <div className="settings-layout">
        ...
        <section className="settings-content">
          ...
          {tab === "agents" && user.role === "ADMIN" && selectedAgent && <AgentCapabilityEditor agent={selectedAgent} onUpdated={onAgentUpdated} onSuccess={success} onError={setError} />}
