...
type SettingsTab = "account" | "appearance" | "members" | "agents" | "automations";
    ...
    <div className="settings-page">
      ...
      <div className="settings-layout">
        <nav className="settings-nav">
          ...
          <button className={tab === "automations" ? "active" : ""} onClick={() => setTab("automations")}><Bot /> Automations</button>
        </nav>
        <section className="settings-content">
          ...
          {tab === "automations" && <AutomationManager project={currentProject} users={users} />}
