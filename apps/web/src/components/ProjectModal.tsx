...
export function ProjectModal({ project, onClose, onSave }: { project?: Project | null; onClose: () => void; onSave: (project: { key: string; name: string; description: string; repoUrl: string | null; color: string }) => Promise<void> }) {
