        ...
        <div className="modal-body">
          ...
          <div className={`project-modal-grid${project ? " has-side" : ""}`}>
            <div className="project-modal-main">
              ...
              {project && <label>Merge target<select aria-label="Merge target" value={mergeTarget} onChange={(event) => setMergeTarget(event.target.value as "main" | "phase")}><option value="main">Main / master branch</option><option value="phase">Active phase branch</option></select><small>Task pull requests target the selected branch. Phase mode creates a phase branch and enables a guarded phase-to-main merge when complete.</small></label>}
            </div>
